...
data1bkg = pd.read_csv(paths[0], names=names_col, delim_whitespace=True)
data1 = pd.read_csv(paths[1], names=names_col, delim_whitespace=True)
data2bkg = pd.read_csv(paths[2], names=names_col, delim_whitespace=True)
data2 = pd.read_csv(paths[3], names=names_col, delim_whitespace=True)
